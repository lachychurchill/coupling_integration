function [ci,q,p,z,hc,idx] = integration(data,gamma)
...
%              hc       cartographic profile
    ...
    %K means analysis
    idx = kmeans(reshape(hc,xNumBins * yNumBins,time)',2); %%also worth increasing k to determine stability of clustering
end
